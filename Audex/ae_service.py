...
if __name__ == "__main__":
    ...
    for i, afname in enumerate(islice(afnames, START, END)):
        ...
        # by transforming signumerization: (1, 44, 16, 1) => (44, 16) => (16, 44) => (22016,)
        ...
        print_info("Euclidean distance between original and immediately restored (& zero end-padded) signals:",
                   np.linalg.norm(asr.af_signal - signal_restored)) # for some reason, not identical from run to run
