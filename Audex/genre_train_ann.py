...
if __name__ == "__main__":
    ...
    inputshape = (x.shape[1], x.shape[2]) # x.shape == (150, 259, 13) for (signalsegments, mfccvectors, mfccs)
    ...
    trainid = "ann_e" + str(args.epochs) + "_" + args.note + "_" + extract_filename(args.traindata_path)
